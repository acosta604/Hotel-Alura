...
public class Busqueda extends JFrame {
	...
	public Busqueda() {
		...
		JLabel lblTitulo = new JLabel("SISTEMA DE BÃšSQUEDA");
		...
		panel.addTab("HuÃ©spedes", new ImageIcon(Busqueda.class.getResource("/imagenes/pessoas.png")), tbHuespedes, null);
		...
		btnEliminar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (filaReservas >= 0) {
					...
					int confirmarh = JOptionPane.showConfirmDialog(null, "Â¿Desea Eliminar los datos?"); 
	...
	private void ActualizarReservas() {		
        ...
        .ifPresentOrElse(fila -> {
			...
			JOptionPane.showMessageDialog(this, String.format("Registro modificado con Ã©xito"));
